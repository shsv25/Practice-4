// 12 варіант
// Протабулювати функцію 4*sin|x/2/1| + 9.1*cos(x-1) на проміжку [0; 12] з кроком 0,1*12 = 1,2. 
// Результати обчислень вивести у вигляді таблиці пар чисел. Якщо шуканих даних немає, то вивести про це повідомлення.
